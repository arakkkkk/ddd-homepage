...
export const Navbar = () => {
        ...
        setAdminMenu(
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu" aria-labelledby="navbarDropdown2">
              ...
              <li>
                <a class="dropdown-item pointer" onClick={() => navigate("/home/service/0/contents/update")}>
                  サービスページの編集
                </a>
              </li>
            </ul>
  ...
  return (
    <nav class="navbar navbar-expand-sm fixed-top" onMouseLeave={() => closeNavCollapse()}>
      <div class="container container-fluid">
        <a class="navbar-brand pointer" onClick={() => navigate("/", { replace: true })} style={{ color: "#FFFFFF" }}>
